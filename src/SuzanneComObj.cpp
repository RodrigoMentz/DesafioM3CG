...
int loadSimpleOBJ(string filePATH, int &nVertices, std::string &arquivoTextura);
...
int main()
{
	...
	Object obj;
	obj.VAO = loadSimpleOBJ("../assets/Modelos3D/SuzanneSubdiv1.obj", obj.nVertices, arquivoTextura);

	// Carregando uma textura e armazenando seu id
	int imgWidth, imgHeight;
	obj.texID = loadTexture("../assets/Modelos3D/" + arquivoTextura,imgWidth,imgHeight);
